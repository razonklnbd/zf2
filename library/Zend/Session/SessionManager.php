...
class SessionManager extends AbstractManager
{
    ...
    {
        #error_log('old session_id: '.session_id().' @'.__LINE__.': '.__FILE__, 0);
        /*
 ...
 error_log('$bkTrace: '.$bkTrace(debug_backtrace()).' @'.__LINE__.': '.__FILE__, 0);
        #}
 # */
        @session_regenerate_id((bool) $deleteOldSession);
        #error_log('new session_id: '.session_id().' @'.__LINE__.': '.__FILE__, 0);
        return $this;
    }
