...
class AuthenticationService implements AuthenticationServiceInterface
{
    ...
    public function authenticate(Adapter\AdapterInterface $adapter = null)
    {
        ...
        // $this->getStorage(): Lib3rdParty\\Zend\\Authentication\\Storage\\Session
        #error_log('$this->getStorage()->getSessionId(): '.$this->getStorage()->getSessionId().' @'.__LINE__.': '.__FILE__, 0);
        // $adapter: Lib3rdParty\\Zend\\Authentication\\Adapter\\DbTable\\CallbackCheckAdapter
        #error_log('$adapter: '.get_class($adapter).' @'.__LINE__.': '.__FILE__, 0);
