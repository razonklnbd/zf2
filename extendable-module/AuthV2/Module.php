...
class Module extends WemproMarketplaceModuleBase implements AutoloaderProviderInterface, ViewHelperProviderInterface {
	...
	public function getServiceConfig() {
		...
		$srvcIdxToUserLoginHandler=self::getServiceIdxToGetUserLoginHandler();
		$srvc2rtrn=array(
		    $srvcIdxToUserLoginHandler=> function($sm) {
								try {
							...
							'AuthV2\\UserLoginHandler'=>function ($sm) use($srvcIdxToUserLoginHandler) { return $sm->get($srvcIdxToUserLoginHandler); },
